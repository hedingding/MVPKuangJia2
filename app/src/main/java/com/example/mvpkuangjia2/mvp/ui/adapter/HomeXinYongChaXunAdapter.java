 ...
 * 修改备注：
 */
public class HomeXinYongChaXunAdapter extends BaseQuickAdapter<HomeImgInfo.DataBean, BaseViewHolder> {
    Context context;

    public HomeXinYongChaXunAdapter(Context context, List<HomeImgInfo.DataBean> list) {
        super(R.layout.homexinyongchaxun_item, list);
